...
def main():
    if len(sys.argv) != 8:
        print("Usage: python3 WriteReportToExcel.py <engine_name> <test_type> <model_name> <session_id> <exec_cmd> <test_cmd> <log_file_path>")
        sys.exit(1)
    ...
    generate_excel(engine_name, model_name, exec_cmd, test_cmd, context_lengths, tuple(unique_batch_sizes), 
