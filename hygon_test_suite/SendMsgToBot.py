...
def main():
    ...
    summary = read_and_format_summary(log_file_path, "aarch64-hygon-Z100L:" + docker_image_version)
    send_summary_to_server("aarch64-hygon-Z100L:" + docker_image_version, None, summary)
